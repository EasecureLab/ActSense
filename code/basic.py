...
name_dict = {'use':'Aggregate', 'air1':'HVAC', 'clotheswasher1':'Washing Machine', 'dishwasher1':'Dishwasher', 'furnace1':'Furnace', 'microwave1':'Microwave', 'refrigerator1':'Fridge'}
APP_NAME_OBSERVED = ['Aggregate', 'HVAC', 'Washing Machine', 'Dishwasher', 'Furnace', 'Microwave', 'Fridge']
